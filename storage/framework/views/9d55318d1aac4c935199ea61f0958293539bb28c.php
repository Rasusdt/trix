    ...
    <script type="text/javascript">
        ...
        function initVKOneTap() {
            if ('VKIDSDK' in window) {
                ...
                VKID.Config.init({
                    app: <?php echo e(env('VKONTAKTE_CLIENT_ID')); ?>,
                    redirectUrl: '<?php echo e(env('VKONTAKTE_REDIRECT_URI')); ?>',
...
</html><?php /**PATH D:\OSPanel\domains\localhost\resources\views/confirm.blade.php ENDPATH**/ ?>