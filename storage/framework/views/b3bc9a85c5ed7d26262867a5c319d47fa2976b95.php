                ...
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        ...
                        <div class="stat-card-value text-success">
                            <?php echo e(App\Payment::query()->where('fake', 0)->whereMonth('created_at', '=', date('m'))->where([['created_at', '>=', \Carbon\Carbon::today()], ['status', 1]])->sum('sum')); ?> ₽
                        </div>
                    </div>
            ...
            <div class="stat-card">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        ...
                        <div class="stat-card-value text-success">
                            <?php echo e(App\Payment::query()->where('fake', 0)->whereMonth('created_at', '=', date('m'))->where([['created_at', '>=', \Carbon\Carbon::today()->subDays(7)], ['status', 1]])->sum('sum')); ?> ₽
                        </div>
                    </div>
                    <div class="stat-card-icon bg-success-light">
            ...
            <div class="stat-card">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        ...
                        <div class="stat-card-value text-success">
                            <?php echo e(App\Payment::query()->where('fake', 0)->whereMonth('created_at', '=', date('m'))->where('status', 1)->sum('sum')); ?> ₽
                        </div>
                    </div>
                    <div class="stat-card-icon bg-success-light">
            ...
            <div class="stat-card">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        ...
                        <div class="stat-card-value text-success">
                            <?php echo e(App\Payment::query()->where('fake', 0)->where('status', 1)->sum('sum')); ?> ₽
                        </div>
                    </div>
                    <div class="stat-card-icon bg-success-light">
                ...
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        ...
                        <div class="stat-card-value text-danger">
                            <?php echo e(App\Withdraw::query()->whereMonth('created_at', '=', date('m'))->where([['fake', 0], ['created_at', '>=', \Carbon\Carbon::today()], ['status', 1]])->sum('sum')); ?> ₽
                        </div>
                    </div>
            ...
            <div class="stat-card">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        <div class="stat-card-title">За 7 дней</div>
                        <div class="stat-card-value text-danger">
                           <?php echo e(App\Withdraw::query()->whereMonth('created_at', '=', date('m'))->where([['fake', 0], ['created_at', '>=', \Carbon\Carbon::today()->subDays(7)], ['status', 1]])->sum('sum')); ?> ₽
                        </div>
                    </div>
                    <div class="stat-card-icon bg-danger-light">
                        <i class="flaticon-calendar-with-a-clock-time-tools"></i>
            ...
            <div class="stat-card">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        <div class="stat-card-title">За месяц</div>
                        <div class="stat-card-value text-danger">
                            <?php echo e(App\Withdraw::query()->whereMonth('created_at', '=', date('m'))->where([['fake', 0], ['status', 1]])->sum('sum')); ?> ₽
                        </div>
                    </div>
                    <div class="stat-card-icon bg-danger-light">
                        <i class="flaticon2-calendar-1"></i>
            ...
            <div class="stat-card">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        <div class="stat-card-title">За все время</div>
                        <div class="stat-card-value text-danger">
                            <?php echo e(App\Withdraw::query()->where([['fake', 0], ['status', 1]])->sum('sum')); ?> ₽
                        </div>
                    </div>
                    <div class="stat-card-icon bg-danger-light">
                        <i class="flaticon-graph"></i>
                ...
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        ...
                        <div class="stat-card-value text-primary">
                             <?php echo e(App\User::query()->count('id')); ?>
                ...
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        ...
                        <div class="stat-card-value text-warning">
                            <?php echo e(App\Withdraw::query()->where('status', 0)->sum('sum')); ?> ₽
                        </div>
                    </div>
    ...
    <div class="row">
        <div class="col-md-12 col-lg-12 col-xl-4 mb-4">
            <div class="stat-card">
                ...
                <div class="stat-card-value <?php echo e(($profitDice >= 0) ? 'text-success' : 'text-danger'); ?>">
                    <?php echo e(round($profitDice, 2)); ?> ₽
                </div>
            </div>
        </div>
        <div class="col-md-12 col-lg-12 col-xl-4 mb-4">
            <div class="stat-card">
                ...
                <div class="stat-card-value <?php echo e(($profitMines >= 0) ? 'text-success' : 'text-danger'); ?>">
                    <?php echo e(round($profitMines, 2)); ?> ₽
                </div>
            </div>
        </div>
        <div class="col-md-12 col-lg-12 col-xl-4 mb-4">
            <div class="stat-card">
                ...
                <div class="stat-card-value <?php echo e(($profitBubbles >= 0) ? 'text-success' : 'text-danger'); ?>">
                    <?php echo e(round($profitBubbles, 2)); ?> ₽
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('admin/layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OSPanel\domains\localhost\resources\views/admin/index.blade.php ENDPATH**/ ?>